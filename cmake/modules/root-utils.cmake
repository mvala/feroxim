function(add_par PACKAGE)
  ...
  add_custom_target(${PACKAGE}.par
    ...
    COMMAND sed -e 's,include ..ROOTSYS./\\\(etc\\|test\\\)/Makefile.arch,include Makefile.arch,\; s/PACKAGE = */PACKAGE = ${PACKAGE}/\; s,SRCS *=.*,SRCS = ${SRCS},\;' < ${CMAKE_SOURCE_DIR}/cmake/pars/Makefile.in | sed -e 's,HDRS *=.*,HDRS = ${HDRS},\; s,FSRCS *=.*,FSRCS = ${FSRCS},\; s,DHDR *=.*,DHDR = ${DHDR},\; s,EINCLUDE *:=.*,EINCLUDE := ${saveEINCLUDE},' > ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/Makefile
    COMMAND cp -pR `root-config --etcdir`/Makefile.arch ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/Makefile.arch
    COMMAND cp -pR ${CMAKE_SOURCE_DIR}/${PACKAGE}/* ${CMAKE_SOURCE_DIR}/pars/${PACKAGE}/
